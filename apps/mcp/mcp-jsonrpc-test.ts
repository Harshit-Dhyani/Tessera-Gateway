...
async function test() {
  ...
  try {
    ...
    // Test 5: get_runtime_state
    const runtimeRes = await send('tools/call', { name: 'get_runtime_state', arguments: {} });
    console.log('5. get_runtime_state:');
    console.log(JSON.stringify(runtimeRes, null, 2));
